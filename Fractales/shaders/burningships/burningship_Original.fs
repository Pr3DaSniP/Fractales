...
vec3[6] Original() {
	vec3 pallet[6];
	pallet[0] = vec3(0.f	/ 255.f,	7.f		/ 255.f,	100.f	/ 255.f);
	pallet[1] = vec3(32.f	/ 255.f,	107.f	/ 255.f,	203.f	/ 255.f);
	pallet[2] = vec3(237.f	/ 255.f,	255.f	/ 255.f,	255.f	/ 255.f);
	pallet[3] = vec3(255.f	/ 255.f,	170.f	/ 255.f,	0.f		/ 255.f);
	pallet[4] = vec3(0.f	/ 255.f,	2.f		/ 255.f,	0.f		/ 255.f);
	pallet[5] = vec3(0.f	/ 255.f,	7.f		/ 255.f,	100.f	/ 255.f);
	return pallet;
}
