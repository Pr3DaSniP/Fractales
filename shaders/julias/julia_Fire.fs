...
vec3[5] Fire() {
	...
	pallet[1] = vec3(255.f	/ 255.f,	20.f	/ 255.f,	0.f		/ 255.f);
	pallet[2] = vec3(255.f	/ 255.f,	200.f	/ 255.f,	0.f		/ 255.f);
	pallet[3] = vec3(255.f	/ 255.f,	20.f	/ 255.f,	0.f		/ 255.f);
	pallet[4] = vec3(20.f	/ 255.f,	0.f		/ 255.f,	0.f		/ 255.f);
	return pallet;
}
